...
public class SignupOne extends JFrame implements ActionListener{
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11_pin,l12,l13,l14,l15;
    ...
    SignupOne(){
        ...
        l11.setBounds(80, 0, 100, 100);
        add(l11);
        
        l1 = new JLabel("APPLICATION FORM NO. "+first);
        l1.setFont(new Font("Raleway", Font.CENTER_BASELINE, 35));
        ...
        l11_pin = new JLabel("Pin Code:");
        l11_pin.setFont(new Font("Raleway", Font.BOLD, 20));
	...
	add(dateChooser);
        ...
        l11_pin.setBounds(100,540,200,30);
        add(l11_pin);
